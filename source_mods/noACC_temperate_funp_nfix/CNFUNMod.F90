...
!    !!  add phosphorus  -X.YANG
 ...
 real(r8)  :: availc_pool_p(bounds%begp:bounds%endp)                  ! The avaible C pool for allocation     (gC/m2)
  ...
  ! Temperate (and boreal) parameters — ACTIVE for Ha1 / Bon
  real(r8) :: Tmin_fix = -2.04_r8   ! Minimum temperature for temperate/boreal Nfix
  real(r8) :: Topt_fix = 32.10_r8   ! Optimum temperature for temperate/boreal Nfix
  real(r8) :: Tmax_fix = 43.98_r8   ! Max temperature for temperate/boreal N fix
  ! Tropical parameters — commented out (use noACC_fixed_funp_nfix for Manaus)
  !real(r8) :: Tmin_fix = 7.04_r8
  !real(r8) :: Topt_fix = 33.22_r8
  !real(r8) :: Tmax_fix = 45.35_r8
