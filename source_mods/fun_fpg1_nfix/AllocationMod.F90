      ...
      ! ============================================================= 
       ...
       if(.not.use_fun)then   
           ...
           if (.not. use_fun ) then !FUN has no concept of FPG   
            if (col_plant_ndemand(c) > 0.0_r8) then
             ...
             !end if        
               ...
               fpg(c) = 1.0_r8  ! FUN handles N limitation via C costs; fpg must stay 1
           end if        
         ...
         do fc=1,num_soilc
           ...
           if (.not. use_funp) then !FUNP has no concept of FPG_P
            if (col_plant_pdemand(c) > 0.0_r8) then
               ...
               fpg_p(c) = 1.0_r8  ! FUN-P handles P limitation via C costs; fpg_p must stay 1
           end if
